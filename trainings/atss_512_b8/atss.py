...
default_hooks = dict(
    ...
    visualization=dict(
        draw=True,
        test_out_dir='/workspace/trainings/atss_512_b8//test_imgs/',
...
launcher = 'none'
load_from = '/workspace/trainings/atss_512_b8//best_coco_bbox_mAP_epoch_103.pth'
log_level = 'INFO'
...
visualizer = dict(name='visualizer', type='mmdet.DetLocalVisualizer')
work_dir = '/workspace/trainings/atss_512_b8'
