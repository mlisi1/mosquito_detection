...
default_hooks = dict(
    ...
    visualization=dict(
        draw=True,
        test_out_dir='/workspace/trainings/tood_512_b8//test_imgs/',
...
launcher = 'none'
load_from = '/workspace/trainings/tood_512_b8//best_coco_bbox_mAP_epoch_128.pth'
log_level = 'INFO'
...
work_dir = '/workspace/trainings/tood_512_b8'
